...
class SaverMixin:
    ...
    DEFAULT_GRID_KWARGS = {"align": "max", "arrange": "horizontal"}
    ...
    def get_image_grid_(self, imgs, align, arrange):
        ...
        return np.concatenate(cols, axis=1 if arrange == "horizontal" else 0)
    ...
    def save_image_grid(
        ...
        arrange=DEFAULT_GRID_KWARGS["arrange"],
        name: Optional[str] = None,
        step: Optional[int] = None,
        ...
        save_path = self.get_save_path(filename)
        img = self.get_image_grid_(imgs, align=align, arrange=arrange)
